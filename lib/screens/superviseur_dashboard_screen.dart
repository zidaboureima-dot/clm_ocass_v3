...
class SuperviseurDashboardScreen extends StatefulWidget {
  ...
  @override
  State<SuperviseurDashboardScreen> createState() => _SuperviseurDashboardScreenState();
}

class _SuperviseurDashboardScreenState extends State<SuperviseurDashboardScreen> {
          ...
          Padding(
            ...
            child: Row(
              children: [
                Expanded(
                  child: Text(
                    'Région : ${widget.profil.region ?? 'non définie'}',
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Card(
                      ...
                      child: ListTile(
                        ...
                        subtitle: Text('${s.prefecture} · ${s.centreSante}', maxLines: 1, overflow: TextOverflow.ellipsis),
                        trailing: Container(
